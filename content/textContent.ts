...
export const textContent: TextContent = {
  about: {
    ...
    description:
    "As a seasoned 🚀 React JS Developer around 1 year of experience, I specialize in tackling complex challenges, including security, performance optimization, and workflow improvements. My expertise lies in building and maintaining intricate web applications, consistently learning and delivering high-quality tasks on time in dynamic, fast paced environments. I have completed Bachelors of Engineering in Computer Science at Matrusri Engineering College, Hyderabad with CGPA of 8.70. ",
    ...
    experiences: [
      {
        ...
        responsibilities: [
          "Working as frontend developer in a project, developing reusable components using NetJS, React, GraphQL, Jest.",
      ...
      },
      {
        ...
        responsibilities: [
          "Led efforts to enhance app performance, resulting in a 100% reduction in card load times, greatly improving user satisfaction.",
          "Actively partcipated in client presentations and across team, worked on creating UI parts of template apps and realted API.",
        ],
      },
      {
        company: "Cognizant",
  ...
  footer: {
    ...
    copyrightText: "© 2024 Sravani. All Rights Reserved.",
